...
\SV
   ...
   //---------------------------------------------------------------------------------
   // Program to test all RV32I instructions 
   // 
   m4_test_prog()
...
\TLV
   ...
   $is_i_instr = (
      $instr[6:2] ==? 5'b0000x || $instr[6:2] ==? 5'b001x0 ||
      $instr[6:2] == 5'b11001
      );
   ...
   $is_lui   = $opcode ==? 7'b01101_11;
   $is_auipc = $opcode ==? 7'b00101_11;
   $is_jal   = $opcode ==? 7'b11011_11;
   ...
   // Common subexpressions for instructions with "complex" behavior
